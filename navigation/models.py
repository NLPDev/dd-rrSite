...
class TopperNavigation(models.Model):
    title = models.CharField(max_length=100, verbose_name='Label')
    ...
    class Meta:
        verbose_name = 'Topper Navigation'
        verbose_name_plural = 'Topper Navigation'
        ordering = ('order', 'title')

    @staticmethod
    def get_published_objects():
        return TopperNavigation.objects.filter(is_published=True)
